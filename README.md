# Cooking bot assistant
# Кулинарный бот - помощник

Умный Telegram-бот для управления кулинарными рецептами и планирования питания, который напрямую взаимодействует с хранилищем **Obsidian** через протокол **MCP (Model Context Protocol)**. 
...
- **Детальное логирование:** Полный аудит вызовов LLM и ответов MCP-сервера в файле `log/mcp.log`.
...
Все файлы, создаваемые ботом в Obsidian, имеют единый стандарт с YAML frontmatter.
...
Перед запуском бота **обязательно** создать базовую структуру папок в корне хранилища Obsidian. Бот использует эти пути для сохранения и поиска данных.
...
## Демонстрация работы
![Демонстрация работы бота](images/demo.png)